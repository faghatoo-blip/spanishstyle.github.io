// ===== SPANISH STYLE E-COMMERCE v1.1.0 =====
...
function renderHeader() {
    ...
    navLinks.innerHTML = `
        <a href="#home" onclick="showView('home')">${__('home')}</a>
        <a href="#clothes" onclick="showView('clothes')">${__('clothes')}</a>
        <a href="#shoes" onclick="showView('shoes')">${__('shoes')}</a>
        <a href="#perfumes" onclick="showView('perfumes')">${__('perfumes')}</a>
        <a href="#promotions" onclick="showView('promotions')">${__('promotions')}</a>
    `;
...
function renderSpecialOffers() {
    ...
    if (!offersGrid || !offersTitle) return;
